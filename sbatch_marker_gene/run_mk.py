...
best_enc_dims = 512
best_dec_dims = 512
best_pos_weight = 1.123
best_neg_weight = 0.971
best_gnn = 'gin'
best_model_k = 2
best_hvg = 2000
...
batchfile.write('#!/bin/bash\n'+
                ...
                f'python3 main_run_best_bench.py --epochs 600 --save_dir ../results_best_bench/{data}/ --dropout {best_drop} --knn {best_knn} --seed {best_seed} --enc_dims {best_enc_dims} --dec_dims {best_dec_dims} --contra_pos_weight {best_pos_weight} --contra_neg_weight {best_neg_weight} --gnn {best_gnn} --model_k {best_model_k} --hvg {best_hvg} --downstream clustering --adata_path ../../data/zgao62/mouse_hippo/mouse_hippo.h5ad \n')
batchfile.close()
