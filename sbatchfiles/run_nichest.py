...
datasets = [151508, 151509, 151510, 151669, 151670, 151671, 151672, 151673, 151674, 151675, 151676]
# datasets = [151507]
for data in datasets:
    ...
    batchfile.write('#!/bin/bash\n'+
                    ...
                    f'python3 main_run.py --savedir ../results/{data} --preprocess --adata_path ../../data/zgao62/dlpfc_h5ad/{data}.h5ad \n')
    batchfile.close()
